/*****************************************************************************
* Filename:          C:\Users\superman\Documents\ecen427\SpaceInvaderTestHW2/drivers/dma_v1_00_a/src/dma.h
* Version:           1.00.a
...
#define DMA_SLV_REG4_OFFSET (DMA_USER_SLV_SPACE_OFFSET + 0x00000010)
#define DMA_SLV_REG5_OFFSET (DMA_USER_SLV_SPACE_OFFSET + 0x00000014)
#define DMA_SLV_REG6_OFFSET (DMA_USER_SLV_SPACE_OFFSET + 0x00000018)
#define DMA_SLV_REG7_OFFSET (DMA_USER_SLV_SPACE_OFFSET + 0x0000001C)
...
#define DMA_mWriteSlaveReg4(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_SLV_REG4_OFFSET) + (RegOffset), (Xuint32)(Value))
#define DMA_mWriteSlaveReg5(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_SLV_REG5_OFFSET) + (RegOffset), (Xuint32)(Value))
#define DMA_mWriteSlaveReg6(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_SLV_REG6_OFFSET) + (RegOffset), (Xuint32)(Value))
#define DMA_mWriteSlaveReg7(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_SLV_REG7_OFFSET) + (RegOffset), (Xuint32)(Value))
...
#define DMA_mReadSlaveReg4(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_SLV_REG4_OFFSET) + (RegOffset))
#define DMA_mReadSlaveReg5(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_SLV_REG5_OFFSET) + (RegOffset))
#define DMA_mReadSlaveReg6(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_SLV_REG6_OFFSET) + (RegOffset))
#define DMA_mReadSlaveReg7(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_SLV_REG7_OFFSET) + (RegOffset))
